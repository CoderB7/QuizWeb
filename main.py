...
# CONNECT TO DB
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql+psycopg2://quiz_web_db_nlc5_user:T6RvlGoPNvvfkOj6fndKwFftr7dhAugU@dpg-cm26gd0cmk4c73cnv68g-a:5432/quiz_web_db_nlc5"
db.init_app(app)
